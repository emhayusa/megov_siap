              ...
              <CardContent>
                <Stack direction="row" spacing={2}>
                  <Avatar
                    alt="Remy Sharp"
                    src={
                      process.env.PUBLIC_URL + "/static/images/avatars/1.jpg"
                    }
                  />
                  <Avatar
                    alt="Travis Howard"
                    src={
                      process.env.PUBLIC_URL + "/static/images/avatars/2.jpg"
                    }
                  />
                  <Avatar
                    alt="Cindy Baker"
                    src={
                      process.env.PUBLIC_URL + "/static/images/avatars/3.jpg"
                    }
                  />
                </Stack>
              </CardContent>
              ...
              <CardContent>
                <Stack direction="row" spacing={2}>
                  <Avatar
                    alt="Remy Sharp"
                    src={
                      process.env.PUBLIC_URL + "/static/images/avatars/4.jpg"
                    }
                  ...
                  <Avatar
                    alt="Remy Sharp"
                    src={
                      process.env.PUBLIC_URL + "/static/images/avatars/5.jpg"
                    }
                  />
                  <Avatar
                    alt="Remy Sharp"
