...
function ManagementsJenis_pensiun() {
  const [currentTab, setCurrentTab] = useState("daftar");

  const tabs = [{ value: "daftar", label: "Daftar Jenis_pensiun" }];
  ...
  return (
    <>
      <Helmet>
        <title>Managements - Jenis_pensiun</title>
      </Helmet>
      <PageTitleWrapper>
        <PageHeader />
      </PageTitleWrapper>
...
export default ManagementsJenis_pensiun;
