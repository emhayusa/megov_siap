...
function ManagementsKelas_tunkin() {
  const [currentTab, setCurrentTab] = useState("daftar");

  const tabs = [{ value: "daftar", label: "Daftar Kelas_tunkin" }];
  ...
  return (
    <>
      <Helmet>
        <title>Managements - Kelas_tunkin</title>
      </Helmet>
      <PageTitleWrapper>
        <PageHeader />
      </PageTitleWrapper>
...
export default ManagementsKelas_tunkin;
