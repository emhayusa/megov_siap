...
import { create, remove, update } from "src/redux/actions/golongan_darah";
...
function Golongan_darahDialog(props) {
  ...
  function isValidated() {
    //console.log(user);
    return data.nama_golongan_darah.length > 0;
  }

  const save = (e) => {
    e.preventDefault();

    const { nama_golongan_darah } = data;
    if (isValidated()) {
      setLoading(true);
      dispatch(create(nama_golongan_darah))
        .then((data) => {
          setLoading(false);
    ...
    >
      ...
      <DialogContent>
        ...
        <TextField
          ...
          label="Nama Golongan_darah"
          name="nama_golongan_darah"
          value={data.nama_golongan_darah}
          onChange={handleInputChange}
          autoComplete="nama_golongan_darah"
          autoFocus
...
Golongan_darahDialog.propTypes = {
  onClose: PropTypes.func.isRequired,
  open: PropTypes.bool.isRequired,
  config: PropTypes.object.isRequired,
};

export default Golongan_darahDialog;
