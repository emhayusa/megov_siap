...
function ManagementsLevel_wilayah() {
  const [currentTab, setCurrentTab] = useState("daftar");

  const tabs = [{ value: "daftar", label: "Daftar Level_wilayah" }];
  ...
  return (
    <>
      <Helmet>
        <title>Managements - Level_wilayah</title>
      </Helmet>
      <PageTitleWrapper>
        <PageHeader />
      </PageTitleWrapper>
...
export default ManagementsLevel_wilayah;
