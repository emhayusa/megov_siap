...
import { create, remove, update } from "src/redux/actions/jenis_jabatan";
...
function Jenis_jabatanDialog(props) {
  ...
  function isValidated() {
    //console.log(user);
    return data.nama_jenis_jabatan.length > 0;
  }

  const save = (e) => {
    e.preventDefault();

    const { nama_jenis_jabatan } = data;
    if (isValidated()) {
      setLoading(true);
      dispatch(create(nama_jenis_jabatan))
        .then((data) => {
          setLoading(false);
    ...
    >
      ...
      <DialogContent>
        ...
        <TextField
          ...
          label="Nama Jenis_jabatan"
          name="nama_jenis_jabatan"
          value={data.nama_jenis_jabatan}
          onChange={handleInputChange}
          autoComplete="nama_jenis_jabatan"
          autoFocus
...
Jenis_jabatanDialog.propTypes = {
  onClose: PropTypes.func.isRequired,
  open: PropTypes.bool.isRequired,
  config: PropTypes.object.isRequired,
};

export default Jenis_jabatanDialog;
