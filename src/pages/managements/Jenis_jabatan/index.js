...
function ManagementsJenis_jabatan() {
  const [currentTab, setCurrentTab] = useState("daftar");

  const tabs = [{ value: "daftar", label: "Daftar Jenis_jabatan" }];
  ...
  return (
    <>
      <Helmet>
        <title>Managements - Jenis_jabatan</title>
      </Helmet>
      <PageTitleWrapper>
        <PageHeader />
      </PageTitleWrapper>
...
export default ManagementsJenis_jabatan;
