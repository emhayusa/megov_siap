...
function ManagementsTipe_jabatan() {
  const [currentTab, setCurrentTab] = useState("daftar");

  const tabs = [{ value: "daftar", label: "Daftar Tipe_jabatan" }];
  ...
  return (
    <>
      <Helmet>
        <title>Managements - Tipe_jabatan</title>
      </Helmet>
      <PageTitleWrapper>
        <PageHeader />
      </PageTitleWrapper>
...
export default ManagementsTipe_jabatan;
