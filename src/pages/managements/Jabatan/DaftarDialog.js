...
import { create, remove, update } from "src/redux/actions/jabatan";
...
function JabatanDialog(props) {
  ...
  function isValidated() {
    //console.log(user);
    return data.nama_jabatan.length > 0;
  }
...
JabatanDialog.propTypes = {
  onClose: PropTypes.func.isRequired,
  open: PropTypes.bool.isRequired,
  config: PropTypes.object.isRequired,
};

export default JabatanDialog;
