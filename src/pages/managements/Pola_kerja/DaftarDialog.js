...
import { create, remove, update } from "src/redux/actions/pola_kerja";
...
function Pola_kerjaDialog(props) {
  ...
  function isValidated() {
    //console.log(user);
    return data.nama_pola_kerja.length > 0;
  }

  const save = (e) => {
    e.preventDefault();

    const { nama_pola_kerja } = data;
    if (isValidated()) {
      setLoading(true);
      dispatch(create(nama_pola_kerja))
        .then((data) => {
          setLoading(false);
    ...
    >
      ...
      <DialogContent>
        ...
        <TextField
          ...
          fullWidth
          id="nama_pola_kerja"
          label="Nama Pola_kerja"
          name="nama_pola_kerja"
          value={data.nama_pola_kerja}
          onChange={handleInputChange}
          autoComplete="nama_pola_kerja"
          autoFocus
...
Pola_kerjaDialog.propTypes = {
  onClose: PropTypes.func.isRequired,
  open: PropTypes.bool.isRequired,
  config: PropTypes.object.isRequired,
};

export default Pola_kerjaDialog;
