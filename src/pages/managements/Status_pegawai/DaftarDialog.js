...
import { create, remove, update } from "src/redux/actions/status_pegawai";
...
function Status_pegawaiDialog(props) {
  ...
  function isValidated() {
    //console.log(user);
    return data.nama_status_pegawai.length > 0;
  }

  const save = (e) => {
    e.preventDefault();

    const { nama_status_pegawai } = data;
    if (isValidated()) {
      setLoading(true);
      dispatch(create(nama_status_pegawai))
        .then((data) => {
          setLoading(false);
    ...
    >
      ...
      <DialogContent>
        ...
        <TextField
          ...
          required
          fullWidth
          id="nama_status_pegawai"
          label="Nama Status_pegawai"
          name="nama_status_pegawai"
          value={data.nama_status_pegawai}
          onChange={handleInputChange}
          autoComplete="nama_status_pegawai"
          autoFocus
...
Status_pegawaiDialog.propTypes = {
  onClose: PropTypes.func.isRequired,
  open: PropTypes.bool.isRequired,
  config: PropTypes.object.isRequired,
};

export default Status_pegawaiDialog;
