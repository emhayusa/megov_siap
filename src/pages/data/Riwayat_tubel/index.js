...
function ManagementsRiwayat_tubel() {
  const [currentTab, setCurrentTab] = useState("daftar");

  const tabs = [{ value: "daftar", label: "Daftar Riwayat_tubel" }];
  ...
  return (
    <>
      <Helmet>
        <title>Managements - Riwayat_tubel</title>
      </Helmet>
      <PageTitleWrapper>
        <PageHeader />
      </PageTitleWrapper>
...
export default ManagementsRiwayat_tubel;
