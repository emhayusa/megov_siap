...
function Reducer(datas = initialState, action) {
  ...
  switch (type) {
    case CREATE_JENIS_PENSIUN_SUCCESS:
      return [...datas, payload];

    case RETRIEVE_JENIS_PENSIUN_SUCCESS:
      return payload;

    case RETRIEVE_JENIS_PENSIUN_FAIL:
      return [...datas];

    case UPDATE_JENIS_PENSIUN_SUCCESS:
    ...
    case DELETE_JENIS_PENSIUN_SUCCESS:
